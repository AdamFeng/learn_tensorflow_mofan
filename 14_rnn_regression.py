...
BATCH_START = 0 # 建立batch data 时候的index
...
def get_batch():
    ...
    # xs shape(50 batch, 20 steps) s\时间点
...
class LSTMRNN(object):
    ...
    def add_input_layer(self):
        ...
        # reshape l_in_y --> (batch, n_steps, cell_size)  转为三维数据
    ...
    for i in range(200):
        ...
        if i == 0:
            ...
            feed_dict={
                model.xs:seq,
                model.ys:res,
                model.cell_init_state:state  # 将init_state设置为上一步的final_state
            }
